...
macro(CHECK_FOR_AVX)
    ...
    if (MSVC)
        ...
        elseif (HAVE_AVX_EXTENSIONS AND MSVC AND NOT MSVC_VERSION LESS 1600)
            set(AVX_FLAGS "${AVX_FLAGS} /arch:AVX")
        elseif (HAVE_AVX_EXTENSIONS AND NOT MSVC)
            set(AVX_FLAGS "${AVX_FLAGS} -mavx")
        endif ()
    else ()
        if (HAVE_AVX2_EXTENSIONS)
            set(AVX_FLAGS "${AVX_FLAGS} -mavx2")
            add_definitions(-DMCPP_AVX2)
        elseif (HAVE_AVX_EXTENSIONS)
            set(AVX_FLAGS "${AVX_FLAGS} -mavx")
            add_definitions(-DMCPP_AVX)
        endif ()
    endif ()
